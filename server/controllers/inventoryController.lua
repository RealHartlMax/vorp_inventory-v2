...
RegisterServerEvent("vorpinventory:onPickupPesos", INVENTORY_SERVICE.PICKUP.PESOS)
...
RegisterServerEvent("vorpinventory:givePesosToPlayer", INVENTORY_SERVICE.GIVE.PESOS)
...
CORE.Callback.Register("vorp_inventory:callback:DropPesos", INVENTORY_SERVICE.DROP.SHARE_PESOS)
